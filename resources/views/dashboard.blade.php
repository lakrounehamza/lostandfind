...
<form class="flex flex-col md:flex-row gap-3" action="{{route('filtre')}}">

    <select name="categorie"
        class="w-[100px] h-10 border-2 border-sky-500 focus:outline-none focus:border-sky-500 text-sky-500 rounded px-2 md:px-3 py-0 md:py-1 tracking-wider">
